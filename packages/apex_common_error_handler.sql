create or replace FUNCTION apex_common_error_handler (
    p_error IN apex_error.t_error
) RETURN apex_error.t_error_result IS
    /* based on https://docs.oracle.com/en/database/oracle/application-express/20.2/aeapi/Example-of-an-Error-Handling-Function.html */
...
BEGIN
    ...
    ELSE
        ...
        IF p_error.ora_sqlcode IN ( - 1, - 2091, - 2290
                                  , - 2291, - 2292 ) THEN
